...
--
-- OPTIONS:
--   - foldKeymaps.closeOnlyOnFirstColumn: Only hides folds when cursor is at the
--     very first column in vim, generally, and `h` is pressed again.
--     (Renamed from the old top-level `hOnlyOpensOnFirstColumn`.)
--
...
return {
  ...
  opts = {
    -- Renamed (2025-12-07) from the old top-level `hOnlyOpensOnFirstColumn = true`.
    foldKeymaps = {
